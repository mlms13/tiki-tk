...
App.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		...
		}, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right()])])).collapsing().frameless().plain(),$bind($_,$_.render))),doom_core_VNodeImpl.Lazy(($_=Tiki.table(null,new tiki_TableHead([new tiki_TableRow([new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("city")])),new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("state")])).center(),new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("population")])).right(),new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("land area")])).right()])]),new tiki_TableFoot([new tiki_TableRow([new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([])),new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("totals:")])).right(),new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 10171215, format : thx_format_NumberFormat.integer, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right(),new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 749.8, format : function(f25,a224) {
			return thx_format_NumberFormat.number(f25,1,a224);
		}, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right()])]),new tiki_TableBody([new tiki_TableRow([new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("Seattle")])),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("WA")])).center(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 652405, format : thx_format_NumberFormat.integer, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 83.9, format : function(f26,a225) {
			return thx_format_NumberFormat.number(f26,1,a225);
		}, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right()]),new tiki_TableRow([new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("New York")])),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("NY")])).center(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 8405837, format : thx_format_NumberFormat.integer, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 302.6, format : function(f27,a226) {
			return thx_format_NumberFormat.number(f27,1,a226);
		}, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right()]),new tiki_TableRow([new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("Boston")])),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("MA")])).center(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 645966, format : thx_format_NumberFormat.integer, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 48.3, format : function(f28,a227) {
			return thx_format_NumberFormat.number(f28,1,a227);
		}, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right()]),new tiki_TableRow([new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("Kansas City")])),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("MO")])).center(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 467007, format : thx_format_NumberFormat.integer, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 315.0, format : function(f29,a228) {
			return thx_format_NumberFormat.number(f29,1,a228);
		}, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right()])])).collapsing().frameless().plain().compact(),$bind($_,$_.render)))])),$bind($_,$_.render)))])),$bind($_,$_.render)));
	}
