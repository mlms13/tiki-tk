...
doom_html_Render.prototype = {
	...
	,createElement: function(name,attributes,children,post) {
		...
		if(colonPos > 0) {
			...
			var ns = tmp;
			if(null == ns) throw new thx_Error("element prefix \"" + prefix + "\" is not associated to any namespace. Add the right namespace to Doom.namespaces.",null,{ fileName : "Render.hx", lineNumber : 367, className : "doom.html.Render", methodName : "createElement"});
