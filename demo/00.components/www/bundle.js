...
App.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		...
		}, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right()]),new tiki_TableRow([new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("New York")])).style(tiki_BoxStyle.Success).contrast().inverted(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("NY")])).center(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 8405837, format : thx_format_NumberFormat.integer, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right().style(tiki_BoxStyle.Warning),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 302.6, format : function(f3,a22) {
		...
		}, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right().style(tiki_BoxStyle.Danger)]),new tiki_TableRow([new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("Kansas City")])),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("MO")])).center(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 467007, format : thx_format_NumberFormat.integer, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right().style(tiki_BoxStyle.Info),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 315.0, format : function(f5,a24) {
		...
		}, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right()]),new tiki_TableRow([new tiki_TableHeaderCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("New York")])),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("NY")])).center(),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 8405837, format : thx_format_NumberFormat.integer, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right().style(tiki_BoxStyle.Success),new tiki_TableDataCell(doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Lazy(($_=new tiki_Number({ value : 302.6, format : function(f26,a225) {
		...
		}, culture : Tiki.defaultCulture}),$bind($_,$_.render)))])).right()])])).style(tiki_BoxStyle.Danger),$bind($_,$_.render)))])),$bind($_,$_.render)))])),$bind($_,$_.render)));
	}
...
var tiki_BoxStyle = { __ename__ : ["tiki","BoxStyle"], __constructs__ : ["Info","Success","Warning","Danger"] };
tiki_BoxStyle.Info = ["Info",0];
tiki_BoxStyle.Info.__enum__ = tiki_BoxStyle;
tiki_BoxStyle.Success = ["Success",1];
tiki_BoxStyle.Success.__enum__ = tiki_BoxStyle;
tiki_BoxStyle.Warning = ["Warning",2];
tiki_BoxStyle.Warning.__enum__ = tiki_BoxStyle;
tiki_BoxStyle.Danger = ["Danger",3];
tiki_BoxStyle.Danger.__enum__ = tiki_BoxStyle;
