...
App.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		return doom_core__$VNode_VNode_$Impl_$.el("article",null,doom_core__$VChildren_VChildren_$Impl_$.children([this.demoSection("Typography",doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("h1",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("h1 heading"))]))),this.fillerText(),doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("h2",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("h2 heading"))]))),this.fillerText(),doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("h3",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("h3 heading"))]))),this.fillerText(),doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("h4",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("h4 heading"))]))),this.fillerText(),doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("h5",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("h5 heading"))]))),this.fillerText(),doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("h6",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("h6 heading"))]))),this.fillerText()])),this.demoSection("Buttons",doom_core__$VChildren_VChildren_$Impl_$.children([this.inlineExample(doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(new tiki_Button({ type : tiki_ButtonType.Default, click : function() {
		}},doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("Default"))])))])),this.inlineExample(doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(new tiki_Button({ type : tiki_ButtonType.Primary, click : function() {
		}},doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("Primary"))])))])),this.inlineExample(doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(new tiki_Button({ type : tiki_ButtonType.Success, click : function() {
		}},doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("Success"))])))])),this.inlineExample(doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(new tiki_Button({ type : tiki_ButtonType.Warning, click : function() {
		}},doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("Warning"))])))])),this.inlineExample(doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Comp(new tiki_Button({ type : tiki_ButtonType.Danger, click : function() {
		}},doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("Danger"))])))]))]))]));
	}
	,demoSection: function(title,children) {
		...
		var tmp = doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("h2",_g1,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text(title))])));
		...
		return doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("section",attributes,doom_core__$VChildren_VChildren_$Impl_$.children([tmp,doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("div",_g2,children))])));
	}
	,inlineExample: function(children) {
		...
		return doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("div",_g,children));
	}
	,fillerText: function() {
		return doom_core_VChildImpl.Node(doom_core__$VNode_VNode_$Impl_$.el("p",null,doom_core__$VChildren_VChildren_$Impl_$.children([doom_core_VChildImpl.Node(doom_core_VNodeImpl.Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean\n              sed hendrerit libero, et tempor orci. Nam facilisis neque at diam\n              blandit, vitae lacinia erat imperdiet."))])));
	}
	,__class__: App
});
...
doom_html_Render.prototype = {
	...
	,renderComponent: function(comp) {
		try {
			...
			throw new thx_error_ErrorWrapper("unable to render " + typeName,e,null,{ fileName : "Render.hx", lineNumber : 237, className : "doom.html.Render", methodName : "renderComponent"});
		}
	}
...
Main.__name__ = ["Main"];
Main.main = function() {
	Doom.browser.mount(doom_core_VChildImpl.Comp(new App({ })),window.document.querySelector("#root"));
};
Math.__name__ = ["Math"];
